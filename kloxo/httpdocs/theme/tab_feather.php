...
function print_tab_button($key, $url, $list)
{
	...
	$imgp = str_replace($skin_color, 'default', $imgp);
...
<?php
	...
	if ($check) {
		if ($key === 0) {
?>
			<td class='tabver'><img src='<?= $imgp ?>/images/menufirstlft20.jpg' border='0' /></td>
<?php
		} else {
?>
			<td class='tabver'><img src='<?= $imgp ?>/images/menulft20.jpg' border='0' /></td>
<?php
		}
?>
		<td class='tabnew'>
...
<?php
		if ($key === $lastkey - 3) {
?>
			<td class='tabver'><img src='<?= $imgp ?>/images/menulastrit20.jpg' border='0' /></td>
<?php
		} else {
?>
			<td class='tabver'><img src='<?= $imgp ?>/images/menufirstlft20.jpg' border='0' /></td>
<?php
		...
		if (!$list[$key - 1]) {
?>
			<td class='tabver'><img src='<?= $imgp ?>/images/menulft21.jpg' border='0' /></td>
<?php
		}
?>
		<td class='tabnew1'>
