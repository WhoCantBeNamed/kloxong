...
class Google extends \League\OAuth2\Client\Provider\AbstractProvider
{
    use \League\OAuth2\Client\Tool\BearerAuthorizationTrait;
    ...
    {
        return new \League\OAuth2\Client\Provider\GoogleUser($response);
    }
}
//Set Redirect URI in Developer Console as [https/http]://<yourdomain>/<folder>/get_oauth_token.php
$provider = new \League\OAuth2\Client\Provider\Google(array('clientId' => $clientId, 'clientSecret' => $clientSecret, 'redirectUri' => $redirectUri, 'scope' => array('https://mail.google.com/'), 'accessType' => 'offline'));
if (!isset($_GET['code'])) {
