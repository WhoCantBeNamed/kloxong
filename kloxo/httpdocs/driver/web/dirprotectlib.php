...
// Important: Dirprotect is a bit tricky. It on its own lacks any synctoSystem. 
// Instead it updates the parent(web) object, and the adding to the virtualhost file is done in that file. 
// This is done in both add(), and 'deleteSpecific'  functions.
