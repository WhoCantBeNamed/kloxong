...
class Uuser extends \Lxclient
{
    ...
    static function addform($parent, $class, $typetd = \null)
    {
        ...
        $res = \rl_exec_get($parent->__masterserver, $parent->syncserver, array("uuser__{$driverapp}", "getShellList"), \null);
        $vlist['nname'] = array('m', \null);
        $vlist['shell'] = array('s', $res);
        $vlist['password'] = array('m', \null);
        $ret['action'] = 'add';
        $ret['variable'] = $vlist;
        return $ret;
    }
    ...
    function updateform($subaction, $param)
    {
        ...
        switch ($subaction) {
            case "shell_access":
                ...
                $res = \rl_exec_get($this->__masterserver, $this->syncserver, array("uuser__{$driverapp}", "getShellList"), \null);
                $vlist['nname'] = array('M', \null);
                $vlist['shell'] = array('s', $res);
                return $vlist;
        }
    ...
    */
    ...
    // This is needed becasue the inithisobjecturle does return null in certain circumstances
    // (parent->username is null), and then inithisobject will be called.
    // We need to override the lxdb inithisobject here and return null too.
