...
<IFRAME style="width:800px; height:600px" src="web-console/index.php?session=<?php 
            echo $servar;
            ?>"></IFRAME>
</div>
<?php 
...
<div style="text-align:center">
	<applet code="com.jcraft.jcterm.JCTermApplet.class" 
		...
		<param name="jcterm.destinations" value="<?php 
...
<div style="text-align:center; width: 640px; height: 480px; margin: 0 auto; border: 0; padding: 0">
	<applet style="width: 640px; height: 480px; border: 1px solid #ddd" 
		...
		<param name=sshapps.connection.host value="<?php 
                echo $ip;
                ?>">
		<param name=sshapps.connection.port value="<?php 
                echo $sshport;
                ?>">
		<param name=sshapps.connection.userName value="<?php 
                echo $parent->username;
                ?>">
		<param name=sshapps.connection.authenticationMethod value=password>
		<param name=sshapps.connection.connectImmediately value=<?php 
                echo $connectimmediately;
                ?>">
	</applet>
</div>
<?php 
