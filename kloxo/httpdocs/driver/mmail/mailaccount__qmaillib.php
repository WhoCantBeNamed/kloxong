...
class Mailaccount__Qmail extends \lxDriverClass
{
    ...
    function syncQmail()
    {
        ...
        if ($this->main->filter_spam_status === 'delete') {
            ...
            if ($this->main->filter_spam_status === 'spambox') {
                $spamdir = "to {$maildirpath}/.Spam/";
            } else {
                if ($this->main->filter_spam_status === 'mailbox') {
